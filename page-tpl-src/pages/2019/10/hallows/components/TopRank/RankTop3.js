...
import avatarHolderImg from '../../mobile/images/avatar-holder.png'
    ...
    return (
        <div className={ 'top-i top-' + ind } key={ 'toper-' + ind }>
            <div className="headpic">
                <span className={ 'icon-s cown cown-' + ind }></span>
            ...
            <div className="score">积分：<span className="txt-hl">{ item.score }</span></div>
            {
                type === 'mod' &&
                    <div
                        className={ 'butn btn-s btn-atte2' + (isLoved ? '-dis' : '') }
