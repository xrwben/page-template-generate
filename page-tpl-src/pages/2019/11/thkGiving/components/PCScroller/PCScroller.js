...
const hasQQBrowserFixer = navigator.userAgent.indexOf('QQBrowser') !== -1
...
export default class PCScroller extends Component {
    ...
    _refresh () {
        ...
        // QQBrowser chromium 70.0.3538.25 设置scrollTop页面丢失部分样式 手动触发repaint
        if (hasQQBrowserFixer) {
            const ruleI = document.querySelector('.rule-i')
            ruleI && (ruleI.innerHTML += '')
        }
    }
