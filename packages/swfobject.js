...
var swfobject = (function () {
	...
	*/
    function showExpressInstall (att, par, replaceElemIdStr, callbackFn) {
        ...
        if (obj) {
            ...
            var fv = 'MMredirectURL=' + encodeURI(window.location).toString().replace(/&/g, '%26') + '&MMplayerType=' + pt + '&MMdoctitle=' + doc.title
	...
	*/
    function createSWF (attObj, parObj, id) {
        var r; var el = getElementById(id)
